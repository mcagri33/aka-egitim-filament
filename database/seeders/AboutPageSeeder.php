    ...
    private function getKazakhContent(): string
    {
        return '<section class="hero-section">
            <div class="container">
                ...
                <p>Бізбен бірге жол жүруге дайынсыз ба? Біз бірге өсеміз.</p>
        ...
        <section class="concept-section">
            ...
            <p>Осы қағидаға сәйкес Академия қызметі оқытушының жетекшілігімен үздіксіз әрі сапалы білім беру арқылы қоғамға қызымет ететін мамандар даярлауға септігімізді тигіземіз.</p>
        </section>
        ...
        <section class="difference-section">
            ...
            <div class="highlight-box">
                ...
                <p>Білім беру қозғалысы менеджерлік қызмет ретінде емес, мұғалім жетекшілігімен жүзеге асатын педагогикалық үдеріс ретінде ұйымдастырылады. Әрбір студентке академиялық бағыт-бағдар беретін кәсіби педагог бекітіледі.</p>
            </div>

            <div class="highlight-box">
                <h3>Мінез-құлық пен қабілетке негізделген бағдарлау</h3>
